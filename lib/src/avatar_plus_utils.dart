class AvatarPlusUtils {
  // Private constructor with initialization logic
  AvatarPlusUtils._internal() {
    _init();
  }

  // Static instance variable, initially created
  static final AvatarPlusUtils _instance = AvatarPlusUtils._internal();

  // Static getter to return the singleton instance
  static AvatarPlusUtils get instance => _instance;

  static const Map<String, Map<String, Map<String, List<String>>>> themes = {
    // Robo
    "00": {
      "A": {
        "env": ["#ff2f2b"],
  ...
  final Map<String, Map<String, String>> avatarMap = {
    '00': {},
    '01': {},
    '02': {},
    '03': {},
  ...
  void _init() {
    ...
    avatarMap['05']?['head'] = head;
    avatarMap['05']?['mouth'] =
        '<path d="m122.83 151.88a10.49 10.489 0 0 1-14.66 0" style="fill:none;' +
            str +
            '6.1996px;stroke:#333;"/>';
    avatarMap['05']?['eyes'] = '<path d="m70.959 94.985h35.031c2.4086 1e-5 4.3612 1.9523 4.3612 4.3606l-2.5864 17.511c-0.3515 2.3799-1.7218 4.3606-3.8457 4.3606h-30.9c-2.1239-1e-5 -3.8457-1.9523-3.8457-4.3606l-2.5864-17.511c1e-5 -2.4082 1.9526-4.3606 4.3612-4.3606z" style="fill:#1a1a1a;' +
        str +
    ...
    avatarMap['14']?['eyes'] =
        '<path d="m133 108.17h14.17m-63.26 0h14.09m-20.69-8.93a21.31 21.31 0 0 1 27.29 0m21.8 0a21.31 21.31 0 0 1 27.29 0" style="fill:none;' +
            str +
            '4.8243px;stroke:#000;"/>';
    avatarMap['14']?['top'] = '<path d="m115.5 51.75c-38.702 5.3101-54.215 18.038-59.863 35.101" style="fill:none;' +
        str +
  ...
  String getFinal(part, partV, theme) {
    ...
    String? svgString = avatarMap[partV]?[part];
